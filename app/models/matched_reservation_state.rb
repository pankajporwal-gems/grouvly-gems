class MatchedReservationState
  ...
  def new!(performer = nil)
    @matched_reservation.transition_to(:new, { occured_on: Time.now, performed_by: performer })
  end

  def unmatch!(performer = nil)
    @matched_reservation.transition_to(:unmatched, { occured_on: Time.now, performed_by: performer })
  end

  def complete!(performer = nil)
    @matched_reservation.transition_to(:completed, { occured_on: Time.now, performed_by: performer })
  end
end
