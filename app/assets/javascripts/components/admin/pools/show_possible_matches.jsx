  ...
  var component = React.createClass({
    ...
    render: function() {
      ...
      if (this.state.collection.size < 1) {
        html = <div className='text-center'>Nothing to match.</div>;
      } else {
        ...
        collection.forEach(function(model, index) {
          ...
          var view = <AdminPoolsReservationItem key={key} model={model} type='second'/>;
          reservations.push(view);
        });
        html = <div>
                <h5 className="text-center"><strong>"Potential matches"</strong></h5>
                {reservations}
              </div>;
      }
